...
uvcond uses your system's default text editor, checked in this order:

1. **`$VISUAL`** — preferred editor for visual editing (GUI editors)
2. **`$EDITOR`** — fallback editor (typically terminal-based)
